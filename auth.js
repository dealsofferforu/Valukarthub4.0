(() => {
  const PROFILE_KEY = 'valuekart_admin_auth_v2';
  const ATTEMPT_KEY = 'valuekart_admin_attempts_v2';
  const SESSION_KEY = 'valuekart_admin_session_v2';
  ...
  // Pre-configured prototype admin account.
  // Username: valuekart_admin
  // Password is stored only as a PBKDF2-SHA256 hash in this file.
  const DEFAULT_PROFILE = Object.freeze({
    version: 2,
    username: 'valuekart_admin',
    salt: 'dQ68Kq3adkPtof68PyJ6VQ==',
    hash: 'C1PJNjr9Ikvl2dzo7Oa9sMOK/nhnumbqmA/wZ7D3/5M=',
    iterations: PBKDF2_ITERATIONS,
    createdAt: '2026-08-12T12:45:00.000Z',
    updatedAt: '2026-08-12T12:45:00.000Z',
    preset: true
  });
  ...
  function getStoredProfile() { return safeJson(localStorage.getItem(PROFILE_KEY)); }
  function getProfile() { return getStoredProfile() || { ...DEFAULT_PROFILE }; }
  ...
  function loginUrl(next = 'admin.html') {
