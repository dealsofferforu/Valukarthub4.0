...
## Admin login
The prototype now opens directly on the admin sign-in screen; there is no first-time sign-up flow.

Default credentials:
- Username: `valuekart_admin`
- Password: `ValueKart@2026`

The password can be changed later from Admin → Security. This is browser-side protection for the static prototype; use server-side authentication for production.
